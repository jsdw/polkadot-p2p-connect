...
pub const GENESIS_AUTHORITIES: [([u8; 32], u64); 6] = [
    (
        hex_literal::hex!("dea6f4a727d3b2399275d6ee8817881f10597471dc1d27f144295ad6fb933c7a"),
        1,
    ),
    (
        hex_literal::hex!("48b623941c2a4d41cf25ef495408690fc853f777192498c0922eab1e9df4f061"),
        1,
    ),
    (
        hex_literal::hex!("f72daf2e560e4f0f22fb5cbb04ad1d7fee850aab238fd014c178769e7e3a9b84"),
        1,
    ),
    (
        hex_literal::hex!("1c151c11cb72334d26d70769e3af7bbff3801a4e2dca2b09b7cce0af8dd81307"),
        1,
    ),
    (
        hex_literal::hex!("680d278213f908658a49a1025a7f466c197e8fb6fabb5e62220a7bd75f860cab"),
        1,
    ),
    (
        hex_literal::hex!("8e59368700ea89e2bf8922cc9e4b86d6651d1c689a0d57813f9768dbaadecf71"),
        1,
    ),
];
