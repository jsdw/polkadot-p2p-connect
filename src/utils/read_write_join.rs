                ...
                match read_poll {
                    Poll::Pending => {
                        ...
                        if write_pending {
                            ...
                            // if both are pending then we return
                            // pending to wait. If the write fut wasn't pending
                            // then we loop around to start writing something new
                            // rather than doing nothing on it while waiting for
                            // read to resolve.
                            return Poll::Pending
                        }
                    },
